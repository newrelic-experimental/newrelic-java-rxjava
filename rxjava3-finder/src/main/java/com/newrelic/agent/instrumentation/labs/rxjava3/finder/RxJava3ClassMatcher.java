...
public class RxJava3ClassMatcher extends ClassMatcher {
	...
	public boolean isMatch(Class<?> var1) {
		...
		boolean b = !classPackage.getName().startsWith("io.reactivex.rxjava3");
		return b;
	}
	...
	public boolean isMatch(ClassLoader loader, ClassReader cr) {
		...
		boolean b = !className.startsWith("io/reactivex/rxjava3");
		return b;
	}
