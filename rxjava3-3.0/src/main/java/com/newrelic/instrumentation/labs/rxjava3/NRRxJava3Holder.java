...
public class NRRxJava3Holder<T>  {
	...
	public NRRxJava3Holder(String type, String n, Transaction txn) {
		name = n;
		transaction = txn;
	...
	public void startSegment() {
		segment = transaction.startSegment("RxJava3/"+rxType+"/TotalTime",name);
	}
